...
def grading_node(state: GraphState) -> Dict[str,Any]:
    ...
    grade = llm_1.with_structured_output(Grade)
...
hallucination_grader = llm_1.with_structured_output(HallucinationGrade)
...
generation_answer_grader = llm_1.with_structured_output(GenerationAnswerGrade)
